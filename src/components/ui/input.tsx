...
const inputVariants = cva(
  'flex w-full rounded-lg border bg-transparent px-4 py-3 text-responsive-sm transition-all file:border-0 file:bg-transparent file:text-responsive-sm file:font-medium placeholder:text-gray-500 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        sm: 'h-9 px-3 py-2 text-responsive-xs',
        default: 'h-12 px-4 py-3 text-responsive-sm',
        lg: 'h-14 px-6 py-4 text-responsive-base',
      },
    },
    defaultVariants: {
      variant: 'default',
