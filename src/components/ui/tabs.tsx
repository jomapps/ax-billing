...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-12 items-center justify-center rounded-lg bg-slate-800 border border-slate-700 p-1 text-slate-400 shadow-gaming',
      className,
    )}
    {...props}
  />
