...
interface OrderBilledViewProps {
  orderId: string
  initialOrderData?: OrderData | null
  className?: string
}

export function OrderBilledView({ orderId, initialOrderData, className }: OrderBilledViewProps) {
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-400">Payment & Billing</p>
          </div>
        </div>
        ...
        <Card className="bg-gray-800/50 border-gray-700">
          ...
          <CardContent className="text-center py-12">
            ...
            <div className="space-y-2 text-sm text-gray-500">
              <p>• Invoice generation with itemized breakdown</p>
              <p>• Multiple payment methods (Fiuu gateway)</p>
              <p>• WhatsApp payment link delivery</p>
              <p>• Payment confirmation and receipt</p>
            </div>
          </CardContent>
        </Card>
      </motion.div>
